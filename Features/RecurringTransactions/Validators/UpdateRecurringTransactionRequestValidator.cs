...
public sealed class UpdateRecurringTransactionRequestValidator : AbstractValidator<UpdateRecurringTransactionRequestDto>
{
    public UpdateRecurringTransactionRequestValidator()
    {
        ...
        RuleFor(x => x.NextExecutionDate).NotEqual(default(DateTime));
